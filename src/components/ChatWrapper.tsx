...
const ChatWrapper: React.FC<ChatWrapperProps> = ({ collectionName, chatWidth, onChatResize, screenshotImage }) => {
  return (
    <div 
    ...
    >
      <ChatInterface collectionName={collectionName} screenshotImage={screenshotImage} />
      <div
