  ...
  return (
    <nav className="bg-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="text-xl font-bold text-gray-800">RASK</Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <NavLink to="/settings" icon={<Settings size={18} />} text="Setting" />
          </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <MobileNavLink to="/profile" icon={<Phone size={18} />} text="Profile" />
            <MobileNavLink to="/settings" icon={<Settings size={18} />} text="Setting" />
          </div>
        </div>
      )}
    </nav>
...
const MobileNavLink = ({ icon, text, to }: { icon: React.ReactNode; text: string; to: string }) => (
  <Link
    to={to}
    className="flex items-center text-gray-700 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium"
  >
