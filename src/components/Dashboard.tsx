      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 gap-4 backdrop-blur-sm">
          <div>
            ...
            <p className="mt-2 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500 font-medium text-lg animate-text-shimmer">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="group relative px-4 py-2.5 bg-gradient-to-br from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden"
            >
              {/* Animated background */}
              ...
              {/* Glow effect */}
              <span className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-[0_0_15px_rgba(239,68,68,0.6)]"></span>
            </button>
          </div>
        </div>
