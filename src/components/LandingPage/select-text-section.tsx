...
const SelectTextSection = () => {
  const selectTextVideoRef = useRef<HTMLVideoElement>(null);

  return (
    <section id="select-text" className="relative py-28 bg-gradient-to-br from-gray-50 to-indigo-50 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Highlight sections to unlock <span className="font-medium text-indigo-600">deep AI analysis</span> and contextual understanding.
          </motion.p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          ...
          <div className="flex-1 relative group">
            ...
            >
              <video
                ...
                preload="auto"
              >
                <source src="/videos/selectText.mp4" type="video/mp4" />
              </video>

            </motion.div>

            {/* Floating decorative elements */}
            <div className="absolute -right-5 -top-5 w-24 h-24 rounded-full bg-indigo-400/10 blur-xl -z-10"></div>
            <div className="absolute -left-5 -bottom-5 w-32 h-32 rounded-full bg-purple-400/10 blur-xl -z-10"></div>
          </div>
          ...
          <div className="flex-1">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -right-8 top-0 h-full w-0.5 bg-gradient-to-b from-transparent via-indigo-400 to-transparent opacity-50"></div>

              <h3 className="text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-800 to-indigo-700">
                Intuitive <span className="whitespace-nowrap">Text Selection</span>
              </h3>

              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our AI understands context when you highlight:
              </p>
...
export default SelectTextSection;